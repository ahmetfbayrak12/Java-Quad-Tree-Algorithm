...
public class BruteForce 
{
	...
	private double calculateR(double Px1, double Py1, double Px2, double Py2)
	{
	...
	/*	Calculate Force	*/
	private double calculateF(double m1, double m2, double r)
	{
	...
	/*	Calculate Force x.	*/
	private double calculateFx(double F, double Px1, double Px2, double r)
	{
	...
	/*	Calculate Force y.	*/
	private double calculateFy(double F, double Py1, double Py2, double r)
	{
		double Fy = (F * (Py2 - Py1))/r;;
		return Fy;
	}

	/*	Calculate Force x and Force y and set them	*/
	private void calculateFxFy(ArrayList<Point> planets, int i, int j)
	{
		double r, F;
	...
	private void update(ArrayList<Point> planets, int i, double dt)
	{
	...
	/*	Reading planets' properties from text	*/
	private void readInput(ArrayList<Point> arrayList, int N)
	{
	...
	/*	Print properties of planets.	*/
	private void printUniverse(ArrayList<Point> arrayList)
	{
	...
	/*	Creating simulation.	*/
	private void drawSpace(ArrayList<Point> planets, int N)
	{
